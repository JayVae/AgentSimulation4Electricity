...
public class ClearingTool {
    ...
    public static class DiffDecComparator implements Comparator {

        @Override
        public int compare(Object o1, Object o2) {
            ResultPair diff1 = (ResultPair) o1;
            ResultPair diff2 = (ResultPair) o2;
            Double d1 = new Double(diff1.getQuantity());
            Double d2 = new Double(diff2.getQuantity());
